...
export const handlers = [
                    ...
                    cronJobs: [
                        {
                            ...
                            suspend: false,
                            active: 0,
                            lastScheduling: "20 min",
                            lastScheduleDateTime: "2023. 05. 03. 오전 08:35:01",
                            age: "1 year",
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/cron-jobs`,
        ({ params }) => {
            const { clusterId } = params;
            return HttpResponse.json({
                success: true,
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/usage/:nodeName`,
        ({ params }) => {
            ...
            data: [
                {
                    ...
                    conditions: [
                        {
                            lastHeartbeatTime: "2024-05-26 12:26:01",
                            lastTransitionTime: "2024-05-10 15:58:42",
                        ...
                        {
                            lastHeartbeatTime: "2024-05-26 12:26:01",
                            lastTransitionTime: "2024-05-10 15:58:57",
                ...
                },
                {
                    ...
                    conditions: [
                        {
                            lastHeartbeatTime: "2024-05-26 12:26:05",
                            lastTransitionTime: "2024-05-10 15:58:47",
                            message: "kubelet has sufficient memory available",
                            reason: "KubeletHasSufficientMemory",
                            status: "False",
                            type: "MemoryPressure",
                        ...
                        {
                            lastHeartbeatTime: "2024-05-26 12:26:05",
                            lastTransitionTime: "2024-05-10 15:59:02",
                            message: "kubelet is posting ready status",
                            reason: "KubeletReady",
                            status: "True",
                            type: "Ready",
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/nodes/:nodeName`,
        ({ params }) => {
            const { clusterId, nodeName } = params;
            return HttpResponse.json({
                success: true,
                data: [
                    {
                        ...
                        addresses: {
                            ExternalDNS:
                                "ec2-3-34-96-151.ap-northeast-2.compute.amazonaws.com",
                            ExternalIP: "3.34.96.151",
                            Hostname:
                                "ip-172-31-11-72.ap-northeast-2.compute.internal",
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/overview`,
        ({ params }) => {
            const { clusterId } = params;
            return HttpResponse.json({
                success: true,
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/overview/namespace`,
            ...
            data: [
                {
                    ...
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/2022-1-OSSP2-turning-7/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/2022-1-OSSP2-turning-7/commits{/sha}",
                },
                {
                    name: "2023-1-CECD3-24-5",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/2023-1-CECD3-24-5/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/2023-1-CECD3-24-5/commits{/sha}",
                },
                {
                    name: "2024_BEOTKKOTTHON_TEAM_23_BE",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/2024_BEOTKKOTTHON_TEAM_23_BE/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/2024_BEOTKKOTTHON_TEAM_23_BE/commits{/sha}",
                },
                {
                    name: "2024_BEOTKKOTTHON_TEAM_23_FE",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/2024_BEOTKKOTTHON_TEAM_23_FE/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/2024_BEOTKKOTTHON_TEAM_23_FE/commits{/sha}",
                },
                {
                    name: "ASCP",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/ASCP/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/ASCP/commits{/sha}",
                },
                {
                    name: "djangoStudy",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/djangoStudy/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/djangoStudy/commits{/sha}",
                },
                {
                    name: "dongkyeomjang",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/dongkyeomjang/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/dongkyeomjang/commits{/sha}",
                },
                {
                    name: "DragonFly-Server",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/DragonFly-Server/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/DragonFly-Server/commits{/sha}",
                },
                {
                    name: "github-stats-box",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/github-stats-box/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/github-stats-box/commits{/sha}",
                },
                {
                    name: "heart-signal-server",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/heart-signal-server/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/heart-signal-server/commits{/sha}",
                },
                {
                    name: "InGlo-Server",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/InGlo-Server/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/InGlo-Server/commits{/sha}",
                },
                {
                    name: "Nightary-team12-AI",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/Nightary-team12-AI/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/Nightary-team12-AI/commits{/sha}",
                },
                {
                    name: "Nightary-team12-mobile",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/Nightary-team12-mobile/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/Nightary-team12-mobile/commits{/sha}",
                },
                {
                    name: "PlanIt",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/PlanIt/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/PlanIt/commits{/sha}",
                },
                {
                    name: "productive-box",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/productive-box/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/productive-box/commits{/sha}",
                },
                {
                    name: "StepStory-Client",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/StepStory-Client/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/StepStory-Client/commits{/sha}",
                },
                {
                    name: "StepStory-Server",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/StepStory-Server/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/StepStory-Server/commits{/sha}",
                },
                {
                    name: "teamTamagochi",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/teamTamagochi/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/teamTamagochi/commits{/sha}",
                },
                {
                    name: "webp11",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/webp11/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/webp11/commits{/sha}",
                },
                {
                    name: "your-beat-server",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/your-beat-server/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/your-beat-server/commits{/sha}",
                },
                {
                    name: "Zolang-server",
                    branchesUrl:
                        "https://api.github.com/repos/dongkyeomjang/Zolang-server/branches{/branch}",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/Zolang-server/commits{/sha}",
                },
            ],
            error: null,
        });
            ...
            data: [
                {
                    name: "dev",
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/Zolang-server/commits/c4dac212c2f5b7275f759321df0ce44366c81fea",
                ...
                },
                {
                    ...
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/Zolang-server/commits/60f44a1cc9b2b9c236d1e2ce7a7c67d96d390e39",
                ...
                },
                {
                    ...
                    commitsUrl:
                        "https://api.github.com/repos/dongkyeomjang/Zolang-server/commits/89d120c8844b3210415cbd61c12a442f1598a8a6",
    ...
    // get pods of cluster
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/pods`,
        async ({ params }) => {
            const { clusterId } = params;
            return HttpResponse.json({
                success: true,
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/pods/namespace`,
        async ({ params, request }) => {
            const { clusterId } = params;
            const namespace = new URL(request.url).searchParams.get(
                "namespace"
    ...
    http.get(`${baseURL}/api/v1/cluster/:clusterId/service`, ({ params }) => {
        ...
        return HttpResponse.json({
            ...
            data: [
                ...
                {
                    serviceName:
                        "my-ingress-ingress-nginx-controller-admission",
                    serviceNamespace: "default",
                    serviceLabels: {
                        "app.kubernetes.io/component": "controller",
                        "app.kubernetes.io/instance": "my-ingress",
                        ...
                        metaData: {
                            ...
                            serviceAnnotations: {
                                "kubectl.kubernetes.io/last-applied-configuration":
                                    '{"apiVersion":"v1","kind":"Service","metadata":{"annotations":{},"name":"zolang-service","namespace":"default"},"spec":{"ports":[{"port":80,"protocol":"TCP","targetPort":8080}],"selector":{"app":"zolang"},"type":"LoadBalancer"}}\n',
                            },
                        },
                        spec: {
                            servicePort: [80],
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/deployments`,
        ({ params }) => {
            const { clusterId } = params;
            return HttpResponse.json({
                success: true,
                data: [
                    ...
                    },
                    {
                        ...
                        namespace: "kube-system",
                        images: ["docker.io/calico/kube-controllers:v3.23.5"],
                        labels: {
                            "k8s-app": "calico-kube-controllers",
                        },
                        replicas: 1,
                    ...
                    },
                    {
                        ...
                        namespace: "kube-system",
                        images: ["kubernetesui/metrics-scraper:v1.0.8"],
                        labels: {
                            "k8s-app": "dashboard-metrics-scraper",
                        },
                        replicas: 1,
                    ...
                    },
                    {
                        ...
                        namespace: "kube-system",
                        images: ["kubernetesui/dashboard:v2.7.0"],
                        labels: {
                            "k8s-app": "kubernetes-dashboard",
                        },
                        replicas: 1,
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/deployments/namespace`,
        ({ params, request }) => {
            const { clusterId } = params;
            const namespace = new URL(request.url).searchParams.get(
                "namespace"
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/deployments/:deploymentName`,
        ({ params }) => {
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/daemons`,
        ({ params }) => {
            const { clusterId } = params;
            return HttpResponse.json({
                success: true,
                data: [
                    ...
                    },
                    {
                        name: "calico-node",
                        namespace: "kube-system",
                        images: ["docker.io/calico/node:v3.23.5"],
                        labels: {
                            "k8s-app": "calico-node",
                        },
                        replicas: 4,
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/daemons/namespace`,
        ({ params, request }) => {
            const { clusterId } = params;
            const namespace = new URL(request.url).searchParams.get(
                "namespace"
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/daemons/:daemonsSetName`,
        ({ params }) => {
            const { clusterId, deploymentName } = params;
            return HttpResponse.json({
                success: true,
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/replicas`,
        ({ params }) => {
            const { clusterId } = params;
            return HttpResponse.json({
                success: true,
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/replicas/namespace`,
        ({ params, request }) => {
            const { clusterId } = params;
            const namespace = new URL(request.url).searchParams.get(
                "namespace"
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/replicas/:replicasSetName`,
        ({ params }) => {
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/statefuls`,
        ({ params }) => {
            const { clusterId } = params;
            return HttpResponse.json({
                success: true,
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/statefuls/namespace`,
        ({ params, request }) => {
            const { clusterId } = params;
            const namespace = new URL(request.url).searchParams.get(
                "namespace"
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/statefuls/:replicasSetName`,
        ({ params }) => {
            const { clusterId, replicaSetName } = params;
            return HttpResponse.json({
                success: true,
    ...
    // get jobs of cluster
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/jobs`,
        ({ params }) => {
            const { clusterId } = params;
            return HttpResponse.json({
                success: true,
    ...
    http.get(
        `${baseURL}/api/v1/cluster/:clusterId/workload/jobs/namespace`,
        ({ params, request }) => {
            const { clusterId } = params;
            const namespace = new URL(request.url).searchParams.get(
                "namespace"
